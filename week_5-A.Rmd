...
q1 <- read_csv("data_538/election-forecasts-2020/presidential_ev_probabilities_2020.csv")

q1 %>%
  ggplot(mapping = aes(x = total_ev, y = evprob_chal)) +
  geom_line(color = "blue") +
  xlim(0,600) +
  labs(x = "Total Electoral Votes", y = "Probability of Occurence") +
  theme_classic()
...
q2 <- read_csv("data_538/election-forecasts-2020/presidential_state_toplines_2020.csv")

q2 %>%
  filter(state == "Wisconsin") %>%
  
  q2 %>%
  ggplot(mapping = aes(x = voteshare_inc, y = evprob_chal)) +
  geom_line(color = "blue") 
